...
module.exports = node => ({
   ...
   * @param {string} options.chaincodeName Name of the chaincode where notification is to be added
   * @param {string} options.channelName Name of the channel where chaincode is instantiated
   * @param {string} options.chaincodeEventName Name of the chaincode event on which notification is to be triggered
   * @param {string} options.notificationURL URL where the notification is to be sent
   ...
   * @function
   * @name list
   * @returns {Array<NotificationEvent>} List of notifications
   * @memberof Notification
   * @method
   * @instance
   */
