...
module.exports = node => ({
   ...
   * @function
   * @return {Promise<Array<ChaincodeType>>} List of chaincodes
   * @memberof Chaincode
   * @method
   * @instance
   */
   ...
   * @property {string} options.chaincodeName Name of the chaincode to invoke
   * @property {stirng} options.channelName Channel on which the chaincode is instantiated
   * @property {string} options.fcn Function name to invoke
   * @property {Array<string>} options.args Array of string to be passed as argument to the invoke function
   * @return {Promise<string>} Invoke result
   * @memberof Chaincode
   * @method
   * @instance
   */
   ...
   * @function
   * @param {object} options Params
   * @property {string} options.chaincodeName Name of the chaincode to query
   * @property {stirng} options.channelName Channel on which the chaincode is instantiated
   * @property {string} options.fcn Function name to use for querying
   * @property {Array<string>} options.args Array of string to be passed as argument to the query function
   * @return {Promise<string>} Query response
   * @memberof Chaincode
   * @method
   * @instance
   */
   ...
   * @function
   * @param {object} options Params
   * @property {string} options.filePath Absolute file path where the chaincode .zip file is stored
   * @property {stirng} options.name Name of chaincode to upgrade
   * @property {string} options.chaincodeVersion New chaincode version
   * @property {stirng} options.channelName Channel on which the chaincode is instantiated
   * @property {Array<string>} options.args Array of string to be passed as argument to the invoke function
   * @return {Promise<string>} Upgrade result
   * @memberof Chaincode
   * @method
   * @instance
   */
