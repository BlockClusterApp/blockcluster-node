...
module.exports = node => ({
   ...
   * @return {Block} Response from server
   * @memberof Explore
   * @method
   * @instance
   */
   ...
   * @return {Transaction} Response from server
   * @memberof Explore
   * @method
   * @instance
   */
   ...
   * @name blocks
   * @param  {string} channelName Name of the channel whose latest block is to be fetched.
   * @return {Array<Block>} Response from server
   * @memberof Explore
   * @method
   * @instance
   */
   ...
   * @name listOrgs
   * @param  {string} channelName Name of the channel whose latest block is to be fetched.
   * @return {Array<string>} Response from server
   * @memberof Explore
   * @method
   * @instance
   */
   ...
   * @param  {string} channelName Name of the channel whose latest block is to be fetched.
   * @return {Array<ChaincodeType>} Response from server
   * @memberof Explore
   * @method
   * @instance
   */
