...
class Platform {
  ...
  async createPrivatehiveNetwork() {}

  async listPrivatehiveNetworks() {}

  async deletePrivatehiveNetwork() {}

  /**
   *
   * @return {PrivatehiveNode}@memberof Privatehive
   */
  async getPrivatehiveNode() {}
}
