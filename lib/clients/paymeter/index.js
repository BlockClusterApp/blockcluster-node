...
/**
 * @classdesc Handles all function related to paymeter
...
class Paymeter {
   ...
   * @returns {Promise<array|object>} An array of wallets or single wallet description
   * @memberof Paymeter
   * @instance
   */
   ...
   * @returns {Promise<boolean>} True if call succeeded
   * @memberof Paymeter
   * @instance
   */
